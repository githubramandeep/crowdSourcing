		...
		.service(
				...
				function($http, $q, $rootScope,$cookies) {
					...
					this.createTask = function(data) {
						...
						$http.post(
								'http://localhost:8080/croud/rest/task/create',
								data, config).success(
					...
					this.getTaskDetails = function() {
						...
						$http
								.get(
										'http://localhost:8080/croud/rest/task/initiatedTask/'
										+ user,
										config)
								.success(
					...
					this.getWorkerDetails = function(taskCategory) {
						...
						$http
								.get(
										'http://localhost:8080/croud/rest/worker/workerLstbyCat/'+taskCategory,
										config)
								.success(
										function(result, status, headers,
												config) {
					...
					this.assignTask = function(data) {
						...
						$http
								.post(
										'http://localhost:8080/croud/rest/workerTaskDetails/assignTaskReq',
										data, config)
								.success(
										function(result, status, headers,
												config) {
					...
					this.getAllTaskByClient = function() {
						...
						$http
								.get(
										'http://localhost:8080/croud/rest/task/clientId/'
												+ clientId,
					...
					this.getTaskDetailsByTaskId = function(taskId) {
						...
						$http.get(
								'http://localhost:8080/croud/rest/task/taskId/'
					...
					this.transferMoney = function(data) {
						...
						$http
								.post(
										'http://localhost:8080/croud/rest/task/payment/',
										data, config)
								.success(
										function(result, status, headers,
												config) {
